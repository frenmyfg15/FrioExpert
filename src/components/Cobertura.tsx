    ...
    <section className="bg-gray-50 py-12 px-4 md:px-10 lg:px-20 my-10">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-gray-600 mb-8">
          Ofrecemos servicio técnico especializado en toda la zona norte de la República Dominicana.
        </p>

        <div className="flex flex-wrap justify-center gap-4 mb-10">
          {ciudadesCibao.map((ciudad) => (
            <button
              key={ciudad}
        ...
        <div className="bg-white rounded-xl shadow-md p-6 max-w-xl mx-auto text-center border">
          <p className="text-gray-700 text-lg mb-4">
            ¿Estás en otra provincia o zona del país? Consulta disponibilidad y condiciones especiales.
          </p>
          <a
