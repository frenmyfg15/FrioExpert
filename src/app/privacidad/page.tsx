...
export const metadata = {
  title: "Política de Privacidad | Yireh Service",
  description: "Conoce cómo Yireh Service protege tus datos personales de forma segura y transparente.",
};
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-16 text-gray-800 mt-20">
      ...
      <section className="space-y-6 text-sm md:text-base leading-relaxed">
        <p>
          En <strong>Yireh Service</strong>, nos comprometemos a proteger tu privacidad y garantizar que tus datos personales sean tratados de forma segura, confidencial y de acuerdo con la legislación vigente, incluyendo el Reglamento General de Protección de Datos (RGPD).
        </p>

        <h2 className="text-xl font-semibold">1. Responsable del tratamiento</h2>
        <p>
          <strong>Nombre comercial:</strong> Yireh Service<br />
          <strong>Teléfono:</strong> 829 919 2022<br />
          <strong>Correo electrónico:</strong> info@YirehService.com<br />
