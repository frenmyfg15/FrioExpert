...
export const metadata = {
  title: "Política de la Empresa | Yireh Service",
  description: "Consulta la política de empresa de Yireh Service. Comprometidos con la transparencia, la calidad del servicio y la satisfacción del cliente.",
};
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-16 text-gray-800 mt-20">
      ...
      <section className="space-y-6 text-sm md:text-base leading-relaxed">
        <p>
          En <strong>Yireh Service</strong>, nos regimos por principios de calidad, integridad y responsabilidad. Nuestra política empresarial está diseñada para garantizar servicios de limpieza eficientes, seguros y confiables, en beneficio de nuestros clientes y del equipo humano que forma parte de nuestra empresa.
        </p>
        ...
        <p>
          Todo nuestro personal pasa por un proceso de selección riguroso. Promovemos un entorno de trabajo seguro, ético y respetuoso, asegurando la confianza tanto en es como en espacios comerciales.
        </p>

        <h2 className="text-xl font-semibold">Sostenibilidad</h2>
        <p>
          En Yireh Service, apostamos por prácticas sostenibles. Minimizar el impacto ambiental es parte de nuestra política mediante el uso de productos biodegradables y procesos responsables con el entorno.
        </p>
        ...
        <p>
          Si deseas más información sobre nuestras políticas o deseas hacernos llegar alguna consulta, puedes escribirnos a: <strong>info@YirehService.com</strong>
        </p>
      </section>
    </main>
  );
