...
export const metadata = {
  title: "Política de Cookies | Yireh Service",
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-16 text-gray-800 mt-20">
      ...
      <section className="space-y-6 text-sm md:text-base leading-relaxed">
        <p>
          En <strong>Yireh Service</strong> valoramos tu privacidad y transparencia. Por eso, te informamos que actualmente <strong>no utilizamos cookies propias ni de terceros</strong> en nuestro sitio web.
        </p>
        ...
        <p>
          Si tienes preguntas sobre nuestra política de cookies o cómo protegemos tu información, puedes contactarnos a través de nuestro correo: <strong>info@YirehService.com</strong>
        </p>
      </section>
    </main>
  );
